...
exports.registerProbLlp = registerProbLlp;
 ...
 */
function registerProbLlp(env) {
    const probObj = new instance_1.Instance("ProbLlpService");
    ...
    probObj.SetProperty("Factorial", {
        ...
        call: (args) => {
            ...
            return (0, values_1.MK_NUMBER)(factorial(n));
        }
    });
    ...
    probObj.SetProperty("Permutations", {
        ...
        call: (args) => {
            ...
            for (let i = n; i > n - k; i--)
                res *= i;
            return (0, values_1.MK_NUMBER)(res);
        }
    });
    ...
    probObj.SetProperty("Combinations", {
        ...
        call: (args) => {
            ...
            return (0, values_1.MK_NUMBER)(num / den);
        }
    });
    ...
    probObj.SetProperty("NormalPDF", {
        ...
        call: (args) => {
            ...
            return (0, values_1.MK_NUMBER)(coeff * Math.exp(exponent));
        }
    });
    ...
    probObj.SetProperty("NormalCDF", {
        ...
        call: (args) => {
            ...
            const sign = z >= 0 ? 1 : -1;
            const erf = sign * poly;
            return (0, values_1.MK_NUMBER)(0.5 * (1 + erf));
        }
    });
    ...
    probObj.SetProperty("Binomial", {
        ...
        call: (args) => {
            ...
            return (0, values_1.MK_NUMBER)(prob);
        }
    });
    ...
    probObj.SetProperty("Uniform", {
        ...
        call: (args) => {
            ...
            return (0, values_1.MK_NUMBER)(min + Math.random() * (max - min));
        }
    });
    probObj.SetProperty("Choice", {
        type: "native_fn",
        call: (args) => {
            const list = args[0]?.type === "list" ? args[0].elements : [];
            if (list.length === 0)
                return (0, values_1.MK_NUMBER)(0);
